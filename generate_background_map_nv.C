...
void generate_background_map_nv(int irun){
  //#####################################################
  //
  ...
  histo_file_name.Form("histsum-%d-0-8.root",irun);    // Input file
	
  TString map_file_name;
  map_file_name.Form("back-para-histsum-%d-0-8.new-vector74-root",irun);   //Output background map
